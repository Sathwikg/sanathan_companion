...
namespace Sanathana.Companion.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260825073423_AddMobileDashboardMenu")]
    partial class AddMobileDashboardMenu
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sanathana.Companion.Domain.Entities.AdFormat", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PlacementGuidance")
                        .HasMaxLength(600)
                        .HasColumnType("character varying(600)");

                    b.Property<bool>("RequiresUserOptIn")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("UX_AdFormats_Code");

                    b.ToTable("AdFormats", (string)null);
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("a1a1a1a1-0001-0001-0001-000000000002"),
                            Code = "interstitial",
                            CreatedBy = "system",
                            CreatedDate = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("a1a1a1a1-0001-0001-0001-000000000003"),
                            Code = "native",
                            CreatedBy = "system",
                            CreatedDate = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("a1a1a1a1-0001-0001-0001-000000000004"),
                            Code = "rewarded",
                            CreatedBy = "system",
                            CreatedDate = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            Id = new Guid("a1a1a1a1-0001-0001-0001-000000000005"),
                        ...
                        new
                        {
                            Id = new Guid("a1a1a1a1-0001-0001-0001-000000000006"),
                            Code = "appOpen",
                            CreatedBy = "system",
                            CreatedDate = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
            ...
            modelBuilder.Entity("Sanathana.Companion.Domain.Entities.AdPlacement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("AdFormatId")
                        .HasColumnType("uuid");

                    b.Property<string>("AndroidAdUnitId")
                        .HasMaxLength(120)
                    ...
                    b.HasIndex("AdFormatId");

                    b.HasIndex("MenuModuleId")
                        .IsUnique()
                        .HasDatabaseName("UX_AdPlacements_MenuModuleId");

                    b.ToTable("AdPlacements", (string)null);
                });

            modelBuilder.Entity("Sanathana.Companion.Domain.Entities.AdSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a1a1a1a1-0002-0002-0002-000000000001"),
                            AdsEnabled = false,
                            CreatedBy = "system",
                            CreatedDate = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            UseTestAds = true
            ...
            modelBuilder.Entity("Sanathana.Companion.Domain.Entities.MenuModule", b =>
                {
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("UX_MenuModules_Code");
            ...
            modelBuilder.Entity("Sanathana.Companion.Domain.Entities.ModuleRoleMapping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedBy = "system",
                            CreatedDate = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            MenuModuleId = new Guid("84848484-8484-8484-8484-848484848484"),
                            MobileEnabled = true,
                            RoleId = 2,
                            WebEnabled = true
                        },
                        new
                        {
                            ...
                            CreatedBy = "system",
                            CreatedDate = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            MenuModuleId = new Guid("81818181-8181-8181-8181-818181818181"),
                            MobileEnabled = true,
                            RoleId = 2,
                            WebEnabled = true
                        },
                        new
                        {
                            ...
                            CreatedBy = "system",
                            CreatedDate = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            MenuModuleId = new Guid("a1a1a1a1-a1a1-a1a1-a1a1-a1a1a1a1a1a1"),
                            MobileEnabled = true,
                            RoleId = 2,
                            WebEnabled = false
                        },
            ...
            modelBuilder.Entity("Sanathana.Companion.Domain.Entities.Puja", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DeityId")
                        .HasDatabaseName("IX_Pujas_Deity");

                    b.HasIndex("FestivalId", "Name")
                        .IsUnique()
                        .HasDatabaseName("UX_Pujas_Festival_Name");

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("FestivalId", "Name"), false);

                    b.ToTable("Pujas", (string)null);
                });

            modelBuilder.Entity("Sanathana.Companion.Domain.Entities.PujaMaterial", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PujaId", "DisplayOrder")
                        .HasDatabaseName("IX_PujaMaterials_Puja_Order");

                    b.ToTable("PujaMaterials", (string)null);
                });

            modelBuilder.Entity("Sanathana.Companion.Domain.Entities.PujaStep", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PujaId", "StepNumber")
                        .IsUnique()
                        .HasDatabaseName("UX_PujaSteps_Puja_Number");

                    b.ToTable("PujaSteps", (string)null);
                });

            modelBuilder.Entity("Sanathana.Companion.Domain.Entities.PujaStepText", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PujaStepId", "LanguageId")
                        .IsUnique()
                        .HasDatabaseName("UX_PujaStepTexts_Step_Language");

                    b.ToTable("PujaStepTexts", (string)null);
                });

            modelBuilder.Entity("Sanathana.Companion.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Sanathana.Companion.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$3Qm5rGml0DHTfjcYb4qBSuwNwEcQPXNbe5v8oJEt2hqNz0oV.KEwG",
                            RoleId = 1,
                            TokensValidFromUtc = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        });
                });
            ...
            modelBuilder.Entity("Sanathana.Companion.Domain.Entities.Wallpaper", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DeityId", "DisplayOrder")
            ...
            modelBuilder.Entity("Sanathana.Companion.Domain.Entities.AdPlacement", b =>
                {
                    b.HasOne("Sanathana.Companion.Domain.Entities.AdFormat", "AdFormat")
                        .WithMany()
                        .HasForeignKey("AdFormatId")
            ...
            modelBuilder.Entity("Sanathana.Companion.Domain.Entities.Puja", b =>
                {
                    b.HasOne("Sanathana.Companion.Domain.Entities.Deity", "Deity")
                        .WithMany()
                        .HasForeignKey("DeityId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Sanathana.Companion.Domain.Entities.Festival", "Festival")
                        .WithMany()
            ...
            modelBuilder.Entity("Sanathana.Companion.Domain.Entities.PujaMaterial", b =>
                {
                    b.HasOne("Sanathana.Companion.Domain.Entities.Puja", "Puja")
                        .WithMany()
            ...
            modelBuilder.Entity("Sanathana.Companion.Domain.Entities.PujaStepText", b =>
                {
                    ...
                    b.HasOne("Sanathana.Companion.Domain.Entities.PujaStep", "PujaStep")
                        .WithMany("Texts")
                        .HasForeignKey("PujaStepId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Language");

                    b.Navigation("PujaStep");
                });

            modelBuilder.Entity("Sanathana.Companion.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("Sanathana.Companion.Domain.Entities.User", "User")
                        .WithMany()
